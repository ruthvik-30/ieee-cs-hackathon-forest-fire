...
#print(dir(tkinter))
wi=Tk()
wi.title("Forest fire detection and animal rescue system")
wi.geometry("500x300")#500px x 200px
...
a=["tiger",86.9,"elephant",86.7,"tiger2",85.9,"deer",84.8,"antelope",86.9,"monkey",87.2,"ape",87.3,"ape2",87.4,"monkey2",87.0]
    ...
    for i in range(0,len(a)):
        if(i%2==1):
            if(a[i]>=86.5 and a[i]<=87.5):
                print(a[i-1],"IS STUCK NEAR A FIRE AND THE COORDINATE IS = ",a[i],end=" ")
 
l1=Label(wi,text=' ').pack()
lab1=Label(wi,text="Click to input the amount of carbon dioxide",bg='Black',fg='White').pack()
bt1=Button(wi,text="CO2",command=onclick)
bt1.pack()

l2=Label(wi,text=' ').pack()
lab2=Label(wi,text="Click for fire detection",bg='Black',fg='White').pack()
bt2=Button(wi,text="FIRE",command=onclick1)
bt2.pack()

l3=Label(wi,text=' ').pack()
lab3=Label(wi,text="Click to calculate distance between animals and fire",bg='Black',fg='White').pack()
bt3=Button(wi,text="DISTANCE",command=onclick2)
bt3.pack()

l4=Label(wi,text=' ').pack()
#lab4=Label(wi,text="",bg='Black',fg='White').pack()
